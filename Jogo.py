...
#TERCEIRO DESAFIO
    ...
    Label(
        canvas,
        text="""Seu terceiro desafio é hackear o sistema de vigilância da garagem mandando cinco algarismos pelos switches, os quais correspondem ao endereço
                ...
                Para mandar através dos switches é preciso enviar a letra 'a' no terminal.\nLembrando que os switches enviam um número em binário!
    ...
    texto = Label(canvas, text=textinho, fg='white',font="Arial 10 bold", bg='black')
    texto.grid(column=0, row=5, padx=10, pady=10)
...
def criar_porta():
    ...
    Label(
        ...
        text= """Seu primeiro desafio é acertar a senha da fechadura!!
                ...
                Após apertar o ""Próximo"", pode fechar essa tela""",
        padx=20,
        pady=20,
        bg='#ffbf00',
        font=f
